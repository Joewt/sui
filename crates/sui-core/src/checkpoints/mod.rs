...
mod tests {
    ...
    pub async fn checkpoint_builder_test() {
        ...
        store.insert(
            d(1),
            e(d(1), vec![d(2), d(3)], GasCostSummary::new(11, 12, 13, 1)),
        );
        store.insert(
            d(2),
            e(d(2), vec![d(3), d(4)], GasCostSummary::new(21, 22, 23, 1)),
        );
        store.insert(d(3), e(d(3), vec![], GasCostSummary::new(31, 32, 33, 1)));
        store.insert(d(4), e(d(4), vec![], GasCostSummary::new(41, 42, 43, 2)));
        for i in [10, 11, 12, 13] {
            store.insert(d(i), e(d(i), vec![], GasCostSummary::new(41, 42, 43, 2)));
        }
        for i in [15, 16, 17] {
            store.insert(d(i), e(d(i), vec![], GasCostSummary::new(51, 52, 53, 3)));
        }
        ...
        assert_eq!(
            ...
            GasCostSummary::new(104, 108, 112, 4)
        );
